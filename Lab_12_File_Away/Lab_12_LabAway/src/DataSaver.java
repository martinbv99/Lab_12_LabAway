...
public class DataSaver
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            idNum = SafeInput.getNonZeroLenString(in,"Enter your ID number"); //could use a regex string instead//
            email = SafeInput.getNonZeroLenString(in,"Enter your email");
            yob = SafeInput.getRangedInt(in,"Enter your year of birth", 1000,9999);

            csvRec = fName + ", " + lName + ", " + idNum + ", " + email + ", " + yob;
